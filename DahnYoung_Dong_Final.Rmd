...
#remove snps with R² value
#ld_within <- Linkage(snps_fil, type="geno-r2", linkageOptions(min.r2=r2))
#returns a dataframe with pairwise p-values between loci, under the null hypothesis that the loci are not in linkage disequillibrium.
