...
# here suggests best K value is 5
```
...
plot(q.matrix, coord = coordinates, method = "map.max", interpol = FieldsKrigModel(10),
     main = "Ancestry coefficients",
     xlab = "Longitude", ylab = "Latitude",cex.lab=1.3,
     resolution = c(1000,1000), cex = 1.5,
...
plot(DEM_base, col = gray.colors(20, start = 0, end = 1), ext = ext, main = "Elevation and Major rivers", cex.lab=1.3, cex = 1.5)
