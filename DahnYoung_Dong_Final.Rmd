...
With the availability of genome-wide SNPs for a few dozens of populations of *Rana sylvatica* from the year of 2018, and the understanding of presumably genetic-based and non-plastic local adaptations for populations that are physically in proximity to each other, we can know start to explore the neutral and adaptive genetic variations over the landscape. Given the pilot data of 16 individuals/genotypes, I would like to know about the standing microgeographic genetic variation:
...
2. qualitatively, how much correspondence is there between the individuals genetic ancestry to environmental variables, such as elevation and river system (visual interpolations and comparisons)?
...
The whole run should be less than 2 minutes (some chunks are quoted out).
...
#### 4.3 Comparing results of different K values
...
##### 4.3.2 Results when K = 3  
![nothing](/Users/danyangdong/Documents/GitHub/finalproject/Results_TESS/TESS_Ancestry_K3.jpeg)
![nothing](/Users/danyangdong/Documents/GitHub/finalproject/Results_TESS/TESS_MAP_K3.jpeg)

##### 4.3.3 Results when K = 4  
...
##### 4.3.4 Results when K = 5  
![nothing](/Users/danyangdong/Documents/GitHub/finalproject/Results_TESS/TESS_Ancestry_K5.jpeg)
![nothing](/Users/danyangdong/Documents/GitHub/finalproject/Results_TESS/TESS_MAP_K5.jpeg)

##### 4.3.5 Results when K = 6  
...
### 5.1 Loading file using the Tutorial takes extra steps

### 5.2 Very data quality necessitates understanding 

### 5.3 Correct SNPs filtering is based on quality check

### 5.4 Ancestry proportion is K dependent

### 5.5 Ancestry mapping is exploratory without testing underlying mechanisms

### 5.6 Elevation and river systems correlate with large scale patterns but not minor differentiations as K increases
