...
## extent didn't match so skip for now 

#A. Load DEM raster (elevation raster):
DEM = elevationLow <- readRDS("./maps/rasters/elevationLow.rds") ## extent didn't match so skip for now 
#plot the map
...
landcover = stack("maps/rasters/nlcd_trans.tif")
