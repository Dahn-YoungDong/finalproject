...
snps_ind_pc is the snps_unind by removing missing individuals. snps_unind is the base snps file import
...
VCFsummary(snps_fil_hwe_high)  ## 16 individuals and 0 SNPs.
```
```{r}
#C. Choose one of the datasets (A or B):
