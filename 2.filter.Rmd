...
ld_within <- Linkage(snps_fil, type="geno-r2", linkageOptions(min.r2=r2)) # Nov 29th, 2020 # seem nothing to be removed. No SNP deviating from HW equilibrium within each pop. I guess because there is only one sample for each population.
