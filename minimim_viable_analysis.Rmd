...
I tried running TreeMix over Yale HPC Grace but it returned error. I just asked HPC and they told me how to run TreeMix in the cluster.
...
frogGenind <- load("frogGenind.Rdata")
...
```{r}
vcf_file = "vcf/rasy_ymf_main.vcf"
...
snps_raw
#r2vcftools::vcfLink is not available...
```
