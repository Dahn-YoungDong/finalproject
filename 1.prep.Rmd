...
capture.output(VCFsummary(snps_unind)) #"16 individuals and 18077 SNPs."
...
#this suggest molecular evolution on SNP-basis. For example, snp1 for 16 individuals, most are homozygous for the reference more frequent allele, yet individual 15 has alternative alleles
```
