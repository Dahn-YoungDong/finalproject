...
### 1.1 set up
```{r}
vcf_file = "vcf/testdata_filter.vcf" #this departs from the flow from Nate about genind object-
...
#reloading the object is not useful, it doesn't run the downstream code. Have to reload the  r2vcftools::vcfLink function everytime
